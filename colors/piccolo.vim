...
call piccolo#Color('ErrorMsg', s:white, s:red, 'bold')
call piccolo#Color('Exception', s:white, s:red, 'bold')
...
call piccolo#Color('MatchParen', s:red, s:none, 'bold')
...
if has("spell")
  call piccolo#Color('SpellBad', s:none, s:none, 'undercurl')
...
call piccolo#Color('StatusLine', s:teal, s:none)
call piccolo#Color('StatusLineNC', s:black, s:teal)
